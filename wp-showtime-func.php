...
if (!empty($rasp)) { ?>
    <p>
    <a href="<?php echo preg_replace("/&date=(0|1|2|3)/", "", $_SERVER['REQUEST_URI']) . "&date=0"; ?>">Сегодня</a> | <a
        href="<?php echo preg_replace("/&date=(0|1|2|3)/", "", $_SERVER['REQUEST_URI']) . "&date=1"; ?>">Завтра</a> | <a
    ...
    <a href="<?php echo preg_replace("/&date=(0|1|2|3)/", "", $_SERVER['REQUEST_URI']) . "&date=3"; ?>"><?php echo russian_date("l, j F", strtotime($mayday) + 60 * 60 * 24 * 3); ?></a></p>
<?php } else { ?>
    <p><a href="<?php echo preg_replace("/.date=(0|1|2|3)/", "", $_SERVER['REQUEST_URI']) . "?date=0"; ?>">Сегодня</a> | <a
        href="<?php echo preg_replace("/.date=(0|1|2|3)/", "", $_SERVER['REQUEST_URI']) . "?date=1"; ?>">Завтра</a> | <a
        href="<?php echo preg_replace("/.date=(0|1|2|3)/", "", $_SERVER['REQUEST_URI']) . "?date=2"; ?>"><?php echo russian_date("l, j F", strtotime($mayday) + 60 * 60 * 24 * 2); ?></a> |
    <a href="<?php echo preg_replace("/.date=(0|1|2|3)/", "", $_SERVER['REQUEST_URI']) . "?date=3"; ?>"><?php echo russian_date("l, j F", strtotime($mayday) + 60 * 60 * 24 * 3); ?></a></p>
<?php }
